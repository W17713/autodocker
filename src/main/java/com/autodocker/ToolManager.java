...
public class ToolManager {
	...
	public String createdir(String dirtocreate) {
     ...
     public static void createEntities(String from, String to) throws IOException{ 
         File assetsPath = new File(from);
         File componentPath = new File(to);
         FileUtils.copyFile(assetsPath, componentPath);
          }
